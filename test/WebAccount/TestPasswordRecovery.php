...
class TestPasswordRecovery extends TestCase
{
    ...
    public function testStartPasswordRecovery(): void
    {
        ...
        $query = <<<'GRAPHQL'
mutation webAccountStartPasswordRecovery($configName: String!, $username: String!, $lang: String!) {
  webAccountStartPasswordRecovery(input: {
...
GRAPHQL;
        ...
        $variables = [
            'configName' => 'intranet',
            'username' => 'peter.pan@neverland.com',
            'lang' => 'en',
        ];
...
mutation webAccountFinishRegistration {
  webAccountFinishRegistration(input: {
    configName: "intranet"
    lang: "de"
